...
void	print_output_simple(t_arg *arg, t_dataprintf *data)
{
...
void	print_output_width(t_arg *arg, t_dataprintf *data)
{
	write(arg->tmp_fd, data->format_mod + arg->before_arg, \
		ft_strlen(data->format_mod + arg->before_arg));
...
void	print_output_width_reverse(t_arg *arg, t_dataprintf *data)
{
	write(arg->tmp_fd, data->format_mod + arg->before_arg, \
		ft_strlen(data->format_mod + arg->before_arg));
	if (arg->output_wide_length > 0)
