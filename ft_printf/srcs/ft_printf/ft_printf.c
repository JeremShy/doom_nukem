...
void	init_dataprintf_and_var(t_dataprintf *data, const char *restrict format)
{
	data->format = format;
...
void	ft_printf_error_reset(t_dataprintf *data)
{
	if (data->error != 100)
		data->format_pos--;
	data->error = 0;
...
int		ft_printf(const char *restrict format, ...)
{
	...
	init_dataprintf_and_var(&data, format);
