...
void	detect_length_mod_hh2(t_dataprintf *data, char conversion)
{
	if (conversion == 'U')
...
void	detect_length_mod_hh1(t_dataprintf *data, char conversion)
{
...
void	detect_length_mod_h2(t_dataprintf *data, char conversion)
{
	if (conversion == 'U')
		transform_u(data->current, (unsigned long int)va_arg(data->ap, \
			unsigned long int));
