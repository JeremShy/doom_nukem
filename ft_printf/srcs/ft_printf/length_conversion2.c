...
void	detect_length_mod_l2(t_dataprintf *data, char conversion)
{
	if (conversion == 'U')
...
void	detect_length_mod_ll2(t_dataprintf *data, char conversion)
{
	if (conversion == 'O')
		transform_o(data->current, (unsigned long int)va_arg(data->ap, \
...
void	detect_length_mod_ll1(t_dataprintf *data, char conversion)
{
	if (conversion == 'd' || conversion == 'i')
		transform_d(data->current, (long long)va_arg(data->ap, long long));
	else if (conversion == 'o')
		transform_o(data->current, (unsigned long long)va_arg(data->ap, \
			unsigned long long));
	else if (conversion == 'u')
		transform_u(data->current, (unsigned long long)va_arg(data->ap, \
			unsigned long long));
	else if (conversion == 'x')
