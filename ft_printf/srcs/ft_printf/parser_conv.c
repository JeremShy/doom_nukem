...
int8_t		parser_conv5(t_dataprintf *data, char char_analyse)
{
	if (char_analyse == 'b')
	{
...
int8_t		parser_conv4(t_dataprintf *data, char char_analyse)
{
	if (char_analyse == 'C')
	{
...
int8_t		parser_conv3(t_dataprintf *data, char char_analyse)
{
	if (char_analyse == 'O')
	{
...
int8_t		parser_conv2(t_dataprintf *data, char char_analyse)
{
	if (char_analyse == 'u')
	{
