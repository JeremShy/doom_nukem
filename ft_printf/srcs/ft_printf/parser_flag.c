...
int8_t		parser_flag4(t_dataprintf *data, char char_analyse)
{
...
int8_t		parser_flag3(t_dataprintf *data, char char_analyse)
{
	if (char_analyse == '%')
	{
...
int8_t		parser_flag2(t_dataprintf *data, char char_analyse)
{
	int tmp_int;
