...
void	flag_color_move_in_arg(t_dataprintf *data, const char *color, size_t move)
{
...
void	flag_color_fg2(t_dataprintf *data, const char *arguments)
{
...
void	flag_color_bg2(t_dataprintf *data, const char *arguments)
{
	if (ft_strncmp("LCYAN", arguments, 5) == 0)
